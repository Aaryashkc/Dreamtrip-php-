...
<body class="bg-light min-h-screen font-sans text-dark flex flex-col">
            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="md:hidden flex items-center">
                    <button 
                        ...
                        class="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-primary hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary transition-colors duration-200"
    ...
    <!-- Include app.js at the end of the body -->
